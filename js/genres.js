...
.then(function(data){
    ...
    for (let i = 0; i < 5; i++) {
        ...
        `<li class="genero-terror">
            <a class="linkgenerosseries uk-animation-scale-up" href="detail-genres.html?id=${generos[i].id}&type=pelicula">${generos[i].name}</a>
        </li>`
    } 
...
.then(function(data){
    ...
    for (let i = 0; i < 5; i++) {
        contenido  += 
        `<li class="genero-terror">
            <a class="linkgenerosseries uk-animation-scale-up" href="detail-genres.html?id=${generos[i].id}&type=serie">${generos[i].name}</a>
        </li>`
